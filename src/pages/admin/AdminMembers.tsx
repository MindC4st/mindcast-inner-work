    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 px-4" onClick={() => setSelected(null)}>
          <div className="bg-[#1A1725] border border-foreground/10 rounded-2xl p-6 w-full max-w-sm" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-[10px] font-body text-foreground/30 uppercase tracking-[0.1em] block mb-2">NFC Bracelet ID</label>
