...
const CommerceInventory = () => {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        <h2 className="font-display text-2xl tracking-wider text-foreground mb-1">INVENTORY</h2>
          ...
          {roles.canAdjustStock && (
            <div className="border border-border rounded-sm p-4 space-y-3 bg-card">
              ...
              <div className="grid grid-cols-2 gap-2">
                <input className={inputCls} placeholder="± quantity" value={adjustDelta} onChange={(e) => setAdjustDelta(e.target.value)} />
