...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      queue_absence_notices: { Args: never; Returns: number }
      queue_notification: {
        Args: {
      ...
      queue_practice_reminders: { Args: never; Returns: number }
      queue_session_reminders: { Args: never; Returns: number }
      raise_room_alert: {
        Args: {
          p_body: string
          p_kind: string
