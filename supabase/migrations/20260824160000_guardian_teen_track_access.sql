-- Let an adult guardian whose household includes a teen read the Teen track.
-- Mirrors kids_addon (which already opens the Child track to the adult payer):
-- a guardian in a household with a teen member can read teen lessons for them.
